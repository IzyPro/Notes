...
namespace Notes.iOS
{
    public class SpeechToTextImplementation : ISpeechToText
    {
        ...
        {
            _timer = NSTimer.CreateRepeatingScheduledTimer(5, delegate { DidFinishTalk(); });
            ...
            inputNode.InstallTapOnBus(0, 1024, recordingFormat, (buffer, when) => { _recognitionRequest?.Append(buffer); });
            ...
            _recognitionTask = _speechRecognizer.GetRecognitionTask(_recognitionRequest, (result, error) =>
            {
                ...
                if(result != null)
                {
                    ...
                    _timer.Invalidate();
                    _timer = null;
                    _timer = NSTimer.CreateRepeatingScheduledTimer(2, delegate { DidFinishTalk(); });
                }
